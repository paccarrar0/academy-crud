            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="create.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Nova Tarefa</a>
                    </div>
                    <?php
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="update.php?id='. $row['id'] .'" class="mr-3"><span class="fa fa-pencil"></span></a>';
